...
public class ArraysPracticeOne {
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(scores)); // we found the second score 85. how will we assign it (look above)
        ...
        for (int i = months.length-1; i >= 0; i--){ // i: represents the index numbers of Array starting from the last
                                                    // index
            System.out.println(months[i]);
