...
public class IterablePractice2 {
    public static void main(String[] args) {
        ...
        names.addAll(Arrays.asList("Ahmed", "ahmed", "aHmEd", "John", "Eron", "Daniel", "Mustafa", "Mohammed", "Ahmed", "ahmed", "Yulia", "Chris"));
        ...
        names2.addAll(Arrays.asList("Ahmed", "ahmed", "aHmEd", "John", "Eron", "Daniel", "Mustafa", "Mohammed", "Ahmed", "ahmed", "Yulia", "Chris"));
        ...
        names3.addAll(Arrays.asList("Ahmed", "ahmed", "aHmEd", "John", "Eron", "Daniel", "Mustafa", "Mohammed", "Ahmed", "ahmed", "Yulia", "Chris"));
