...
public class ArithmeticOperators {
    public static void main(String[] args) {
        ...
        int num1 = 9;
        int num2 = 3;
        int division = num1 / num2; // division variables contains the result of num1 divided by num2
        ...
        //what's the remainder of 25 divided by 4: => 1

        System.out.println(25 % 4);

        // what's the remainder of 25 divided by 5: => 0
