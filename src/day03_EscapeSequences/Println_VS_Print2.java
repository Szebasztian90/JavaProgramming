...
public class Println_VS_Print2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Knock Knock"); // first it prints knock knock, then ut appends a new line
        ...
        System.out.println();
        System.out.println("-----------------------");
        System.out.println("Hello everyone? how are you al; today? Today we will learn Escape Sequences and next week we will learn and next week we will learn Variables");
...
// Single line Comment goes after
