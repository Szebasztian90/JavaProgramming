...
public class RemoveDuplicates {
    public static void main(String[] args) {
        ...
        String result = "";
                        // i <= 7 ==> i<8
        for (int i = 0 ; i <= str.length()-1; i++) { // i: represents the all the index number of str (starting from 0)
...
2. Write a program that can remove the duplicated characters from a String
			...
			Hint: You can add each characters of the string into another String
				  Condition: the character is not contained in the other String
				  yet before you are adding
 */